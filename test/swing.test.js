...
test("buildStructure: 未突破外部高点 → INTERNAL_BULLISH", () => {
  const labeled = [
    { type: "LOW", price: 100, index: 2, label: "LL" },
    { type: "HIGH", price: 112, index: 7, label: "HH" }, // 外部高点 112
    { type: "LOW", price: 95, index: 12, label: "LL" }, // 外部启动点
    { type: "HIGH", price: 105, index: 17, label: "LH" },
    { type: "LOW", price: 98, index: 22, label: "HL" },
    { type: "HIGH", price: 108, index: 27, label: "HH" }, // 108 < 112，未突破外部高点
    { type: "LOW", price: 103, index: 32, label: "HL" },
  ];
  const s = buildStructure(labeled);
  assert.equal(s.direction, "BULLISH");
